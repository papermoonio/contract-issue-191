...
if (!context_1.HardhatContext.isCreated()) {
    ...
    const url = `${constants_1.BASE_URL}:${polkadotNodePort}`;
    const networkName = constants_1.POLKADOT_TEST_NODE_NETWORK_NAME;
    ...
    const provider = new lazy_initialization_1.LazyInitializationProviderAdapter(async () => {
        ...
        return (0, construction_1.createProvider)(resolvedConfig, networkName, artifacts, ctx.providerExtenders);
    });
