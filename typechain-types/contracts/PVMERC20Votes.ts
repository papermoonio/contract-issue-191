...
export interface PVMERC20VotesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "allowance"
...
export interface PVMERC20Votes extends BaseContract {
  connect(runner?: ContractRunner | null): PVMERC20Votes;
  waitForDeployment(): Promise<this>;

  interface: PVMERC20VotesInterface;
